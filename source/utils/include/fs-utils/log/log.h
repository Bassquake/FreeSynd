...
#define FSERR(t, c, m, str) { if (Log::canLog(t)) {Log::logHeader(t, c, m, "ERROR"); Log::logMessage str;} printf ("ERROR: "); printf("%s", str); printf("\n");}  // NOLINT
#define FSINFO(t, c, m, str) { if (Log::canLog(t)) {Log::logHeader(t, c, m, "INFO "); Log::logMessage str;} printf ("INFO : "); printf("%s", str); printf("\n");}  // NOLINT
